#!/usr/bin/env bash
# Partial reimport — pełna struktura i userzy, ale tylko pierwsze 150 000 postów.
...
echo "==> Import postów (pierwsze 150 000)"
python manage.py import_posts "${SFINIA_FULL}" --first 150000 --import-db "${SFINIA_FULL}"
