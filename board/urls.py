...
urlpatterns = [
    ...
    path("board/<int:board_id>/new/preview/", views.preview_new_topic, name="preview_new_topic"),
    ...
    path("admin/order/subboards/<int:board_id>/", views.admin_order_children, name="admin_order_children"),
    path("admin/order/section/<int:pk>/move/<str:direction>/", views.admin_order_move_section, name="admin_order_move_section"),
    path("admin/order/board/<int:pk>/move/<str:direction>/", views.admin_order_move_board, name="admin_order_move_board"),
